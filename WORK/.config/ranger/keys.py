...
map.dir('bb', alias='<end>')#Zeltak:go to end
map.dir('G', alias='<end>')
...
#seems to screw writin x below and thus commented out
...
map('<F12>>', fm.execute_console('shell aunpack %s'))
map('<F11>', fm.open_console('shell apack  %s', position=len('shell apack ')))
