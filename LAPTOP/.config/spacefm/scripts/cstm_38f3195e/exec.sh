...
spacefm -s set panel3_visible false;
spacefm -s set --panel 2 current_tab 4; spacefm -s set --panel 2 current_tab close ;
spacefm -s set --panel 2 current_tab 3; spacefm -s set --panel 2 current_tab close ;
spacefm -s set --panel 2 current_tab 2; spacefm -s set --panel 2 current_tab close ;
spacefm -s set --panel 2 current_tab 1; spacefm -s set --panel 2 current_tab close ;
spacefm -s set --panel 1 current_tab 4; spacefm -s set --panel 1 current_tab close ;
spacefm -s set --panel 1 current_tab 3; spacefm -s set --panel 1 current_tab close ;
spacefm -s set --panel 1 current_tab 2; spacefm -s set --panel 1 current_tab close ;
spacefm -s set --panel 1 current_tab 1; spacefm -s set --panel 1 current_tab close ;
